...
################################################################################
bubblebeam(main.data = main.data, main.exclude = FALSE,main.x = input.main.x,
                 main.y = input.main.y,main.size = input.main.size,main.color = input.main.color,
                 SS_cutoff = input.SS_cutoff,FC_cutoff = input.FC_cutoff,
                 NS_cutoff = input.NS_cutoff, plot_theme = input.plot_theme,
                 bubble_label = input.bubble_label,label_color = input.label_color,
                 bubble_color = input.bubble_color, outline_color = input.outline_color,
