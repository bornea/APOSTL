...
![Capabilities](https://raw.githubusercontent.com/bornea/APOSTL/master/wk_images/figure1_from_manuscript.tif)

![shiny_output](https://raw.githubusercontent.com/bornea/APOSTL/master/wk_images/figure4_from_manuscript.tif)
...
```R
> install.packages(c("dplyr", "tidyr", "httr", "jsonlite", "colorRamps", "gplots", "ggrepel", "ggplot2", "data.table", "rcytoscapejs", "stringr", "VennDiagram", "devtools", "visNetwork"), repos = "http://cran.us.r-project.org") 
